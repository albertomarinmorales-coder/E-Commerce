...
export default function BebidasPage() {
  ...
  const convertToProduct = (producto: any) => ({
    ...
    name: producto.name,
    description: `${producto.name} - Bebidas refrescantes`,
          ...
          <div className="flex items-center">
            <div>
              ...
              <p className="text-lg text-teal-100 mb-2">
                Refrescos, zumos, agua y más bebidas
              </p>
              <div className="flex items-center space-x-4 text-sm">
                <span className="bg-teal-500 text-white px-3 py-1 rounded-full font-medium">
                  {productos.length} productos disponibles
                </span>
                <span className="text-teal-100">Siempre frías</span>
                <span className="text-teal-100">Gran variedad</span>
              </div>
            </div>
          </div>
        </div>
